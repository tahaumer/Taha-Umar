      ...
      <div className='container flex py-20' id='explore'>
        ...
        <div className='w-full grid gap-20 grid-cols-3'>
          ...
          <div className='text-[150px] pl-10  text-white font-roman leading-tight whitespace-nowrap col-span-2'>
            ...
            <motion.div viewport={{ once: true }}  initial={{ opacity: 0, x: 25 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: "easeInOut", delay: 1 }} ><Link to="/projects" className='hover:tracking-widest transition-all duration-300'>Projects</Link></motion.div>
